...
rows = query({'select': 'slug,name_zh,sku,brand,status',
              'or': '(sku.ilike.DD-TS*,sku.ilike.DD-WV*,sku.ilike.DD-SHO*,sku.ilike.DD-PAD*)',
              'order': 'sku', 'limit': '50'})
...
print('== 线上API抽查 ==')
try:
    u = 'https://products.dedaautoparts.com/api/search?' + urllib.parse.urlencode({'q': '牵引座', 'limit': '3'})
